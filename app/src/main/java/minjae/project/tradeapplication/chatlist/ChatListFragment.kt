...
import minjae.project.tradeapplication.chatdetail.ChatRoomActivity
import minjae.project.tradeapplication.databinding.FragmentChatlistBinding
...
class ChatListFragment : Fragment(R.layout.fragment_chatlist) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        chatListAdapter = ChatListAdapter(onItemClicked = { chatRoom ->
            // 채팅방으로 이동 하는 코드
            // require 사용해도 되지만 null러블 하게 만들면 context사용가능
            context?.let {
